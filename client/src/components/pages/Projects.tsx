                ...
                <div className="carousel-inner c-inner  active">
                    <div className="carousel-item c-item active">
                        <div className="my-border d-block c-div">
                            ...
                            <p>I led the development of the Interational Badger Bonds website.</p> 
                            <ul>
                            ...
                            <p className="skills-p"><b>Skills: </b>Django, MySQL, JavaScript, HTML, CSS</p>
                            <div className="button-container">
                                <button className="resume-button" onClick={() => window.open('https://internationalbadgerbonds.pythonanywhere.com/', '_blank')}><b>Visit Site!</b></button>
                                <button className="resume-button" onClick={() => window.open('https://github.com/MathomJohnson/IBB_Website', '_blank')}><b>GitHub</b></button>
                            </div>
                        </div>
                    </div>
                    <div className="carousel-item c-item">
                        <div className="my-border d-block c-div">
                            ...
                            <p>I wrote a Python script that texts my Canvas grades to my phone automatically.</p>
                            <ul>
                            ...
                            <div className="button-container">
                                <button className="resume-button" onClick={() => window.open('https://github.com/MathomJohnson/Canvas-Messenger', '_blank')}><b>GitHub</b></button>
                            </div>
                        </div>
                    </div>
                    <div className="carousel-item c-item">
                        <div className="my-border d-block c-div">
                            ...
                            <p>I built a Selenium script to automatically solve the daily Wordle.</p>
                            <ul>
                            ...
                            <div className="button-container">
                                <button className="resume-button" onClick={() => window.open('https://github.com/MathomJohnson/Wordle-Solver', '_blank')}><b>GitHub</b></button>
                            </div>
                        </div>
                    </div>
                </div>
